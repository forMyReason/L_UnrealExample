...
void SPivotToolEditor::Construct(const FArguments& InArgs, TSharedRef<FPivotToolEdModeToolkit> InParentToolkit)
{
	...
	ToolDetailsViewArgs.bUpdatesFromSelection = false;
	ToolDetailsViewArgs.bLockable = false;
	ToolDetailsViewArgs.bAllowSearch = false;
	ToolDetailsViewArgs.NameAreaSettings = FDetailsViewArgs::HideNameArea;
