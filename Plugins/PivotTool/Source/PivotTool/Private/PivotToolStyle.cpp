...
void FPivotToolStyle::SetupStyles(FSlateStyleSet* Style)
{
	...
	// TextStyle
	{
		...
		Style->Set("PivotTool.CheckboxText.DarkerGray", FTextBlockStyle(DefaultNormalTextStyle)
		...
		const FLinearColor ColorLinkText(0.65f, 0.65f, 0.65f, 0.8f);
		const FLinearColor ColorLinkHightText(0.65f, 0.65f, 0.65f, 1.f);
		Style->Set("PivotTool.Property.LinkText", FTextBlockStyle()
			.SetFont(FAppStyle::GetFontStyle(TEXT("PropertyWindow.NormalFont")))
			.SetFontSize(8)
			.SetColorAndOpacity(ColorLinkText)
			.SetHighlightColor(ColorLinkHightText));
		Style->Set("PivotTool.Property.LinkText.Small", FTextBlockStyle()
			.SetFont(FAppStyle::GetFontStyle(TEXT("PropertyWindow.NormalFont")))
			.SetFontSize(7)
			.SetColorAndOpacity(ColorLinkText)
			.SetHighlightColor(ColorLinkHightText));

		const FLinearColor ColorChangeLogHeaderText(0.8f, 0.8f, 0.8f, 0.9f);
		Style->Set("PivotTool.ChangeLogHeaderText", FTextBlockStyle()
			.SetFont(FAppStyle::GetFontStyle(TEXT("PropertyWindow.NormalFont")))
			.SetFontSize(11)
			.SetColorAndOpacity(ColorChangeLogHeaderText));
	}
	...
	// Button Style
	{
		...
		FButtonStyle HyperlinkButton = FButtonStyle(FAppStyle::Get().GetWidgetStyle<FButtonStyle>("Documentation.Hyperlink.Button"));//  // Credits.Hyperlink
		Style->Set("PivotTool.HyperLinkButton.Normal", HyperlinkButton);
	...
	// Checkbox Style
	{
		...
		const FCheckBoxStyle& DefaultToggleButtonStyle = FAppStyle::Get().GetWidgetStyle<FCheckBoxStyle>("ToggleButtonCheckbox");
